 ...
 */
//@javax.persistence.Table(name = "File", schema = "", catalog = "461PROJECT")
//@Entity
...
//        return true;
//    }
    public FileEntity(int fid, String filename, int shared, UserEntity user, String size, String type, Date createdate) {
